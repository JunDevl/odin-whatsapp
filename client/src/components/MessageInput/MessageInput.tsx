...
const MessageInput = ({ kind }: Props) => {
  ...
  return (
    <footer className="z-20 p-1 bg-transparent">
      <form id="message_form" method="POST" onSubmit={onSubmitMessage} ref={form} className="bg-transparent">
        <label className="flex bg-dark-300 rounded-full p-2" htmlFor="content">
          <button id="send" className="p-2 px-3 w-10">
