  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ul className="detail p-1 flex *:flex *:h-10 flex-col items-stretch [&>li>button]:bg-dark-500 [&>li>button]:flex [&>li>button]:flex-1 [&>li>button]:justify-between [&>li>button]:items-center [&>li>button]:gap-2 [&>li>button]:hover:bg-dark-600 [&>li>button]:cursor-pointer [&>li>button>svg]:max-w-5 [&>li>button>p]:flex-1 [&>li>button>p]:text-left">
            {isOwn && <>
              <li>
                <button className="pencil" onClick={openMessageModal}>
              ...
              <li>
                <button className="info" onClick={openMessageModal}>
